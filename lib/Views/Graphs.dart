...
List<Map> data=[{
  ...
  'description':"Shows A detailed Graph about latest Monthly Records available",
...
_page(BuildContext context){
  return Container(
    ...
    child: ScreenTypeLayout(mobile: ListViewBuilder(data),tablet: GridViewBuilder(data,2),desktop:GridViewBuilder(data,3) ,
